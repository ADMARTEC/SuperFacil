...
{
    public class Fin_Gen_Moeda_Cambio_Service : ServiceBase<Fin_Gen_Moeda_Cambio>, IFin_Gen_Moeda_Cambio_Service
    {
        public Fin_Gen_Moeda_Cambio_Service(IRepositoryBase<Fin_Gen_Moeda_Cambio> repository) : base(repository)
        {
        }
    }
}
